...
class CountryCVCell : NSCollectionViewItem {
    ...
    func setup() {
        ...
        checkMark.anchor(top: nil, paddingTop: 0, bottom: nil, paddingBottom: 0, left: nil, paddingLeft: 0, right: self.view.trailingAnchor, paddingRight: 10, width: 10, height: 7)
